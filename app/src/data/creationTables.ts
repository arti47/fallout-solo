export const VAULT_EXPERIMENTS = [
  ...
  { roll: 6, name: 'Artificial Intelligence', desc: 'Overseen by an AI with inhuman views on caring.', truths: ['Security turrets', 'Disciplined residents'] },
  { roll: 7, name: 'Military Perfection', desc: 'Aiming to create the perfect soldier through rigorous discipline.', truths: ['Laboratories', 'Test subject cells'] },
  { roll: 8, name: 'Pharmaceutical Trials', desc: 'Creating a series of revolutionary new Chems.', truths: ['Row upon row of clean white'] },
  ...
  { roll: 12, name: 'Calvinist Reversal', desc: 'Wealth is no longer even a concept here.', truths: ['Degeneration'] },
